...
test("test render a success toast", () => {
  const succesBaseResponse = new BaseResponse({
...
test("test render a failed toast", () => {
  const errorBaseResponse = new BaseResponse({
...
test("test render a partial success toast", () => {
  const partialSuccesBaseResponse = new BaseResponse({
    resultCode: ResultCodeEnum.PartialSuccess,
    resultItem: {},
    userMessage: "partialSuccess",
  });
